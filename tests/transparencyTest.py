...
pygame.draw.rect(red_image, RED, red_image.get_rect(), 20)
pygame.draw.rect(green_image, GREEN, green_image.get_rect(), 20)
pygame.draw.rect(blue_image, BLUE, blue_image.get_rect(), 20)
pygame.draw.rect(purple_image, PURPLE, purple_image.get_rect(), 20)
    ...
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            if event.key == pygame.K_1:
                screen.blit(red_image, (25, 25))
            elif event.key == pygame.K_2:
                screen.blit(green_image, (50, 50))
            elif event.key == pygame.K_3:
                screen.blit(blue_image, (75, 75))
            elif event.key == pygame.K_4:
                screen.blit(purple_image, (100, 100))
